...
router.post('/actualizarUsuario', [authjwt.verifyToken, authjwt.isAdmin, verificarSingup.checkRolExiste, verificarSingup.checkUsuarioOCorreoDuplicado], userCtrl.ActualizarUsuario);
